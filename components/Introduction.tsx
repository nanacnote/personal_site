                          ...
                          <div className="w-100 p-3 border rounded">
                            ...
                            <div>
                              {Object.entries(E?.projects).map((e) => (
                                <div key={e[0]} className="px-3" onClick={() => context.setProjectsHydrator(allProjects[(e[1] as any)?.componentName]?.component)}>
                                  <li>
                                    <Link href={(e[1] as any)?.link}>
                                      <a href="#" data-no-decoration data-inherit-color>{e[0]}</a>
                                    </Link>
                                  </li>
                                </div>
                              ))}
