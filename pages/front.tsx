...
export const Front = ({ post }): JSX.Element => {
  ...
  useEffect(() => {
    ...
    tl_scrollViews
      ...
      .fromTo(
        '.main-pic-header, .main-numbers-header',
        { opacity: 1 },
  ...
  useEffect(() => {
    tl_textVid
      .to(
        '.grad-hr',
        { duration: 2, width: '100%', ease: 'bounce.out' },
        '+=2.5'
      )
      .to(
        '.main-text-row',
      ...
      .to(
        '.main-pic-wrapper',
        { duration: 0.25, rotation: 2160, stagger: 0.05 },
        '-=0.25'
      )
      .from(
        '.main-pic-header, .main-numbers-header',
      ...
      .set('.front-page-right-bottom', { display: 'block' })
      .set('.t-01', {
        y: '-500%',
        display: 'inline',
        fontSize: '1rem',
  ...
  useEffect(() => {
    tl_landing
      ...
      .to(
        '.sider',
        { duration: 1.5, height: '100vh', ease: 'bounce.out' },
        '-=3.5'
      )
